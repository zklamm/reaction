                      ...
                      <div id="cards-container" data-id="list-1-cards">
                        ...
                        <div className="card-background">
                          <div className="card ">
                            ...
                            <div className="card-info">
                              <p>
                                Use the + in the top menu to make your first
                                board now.
                              </p>
                            </div>
                      ...
                      <div id="cards-container" data-id="list-2-cards">
                        <div className="card-background">
                          <div className="card ">
                            ...
                            <div className="card-icons">
                              <i className="clock-icon sm-icon due-soon ">
                                Sep 5
                              </i>
                            </div>
                          </div>
                        ...
                        <div className="card-background">
                          <div className="card ">
                            ...
                            <div className="card-info">
                              <p>
                                You can also change the background and more.
                              </p>
                            </div>
                            <div className="card-icons"></div>
                          </div>
                      ...
                      <div id="cards-container" data-id="list-3-cards">
                        <div className="card-background">
                          <div className="card ">
                            ...
                            <div className="card-info">
                              <p>
                                This is a card. Drag it onto "Tried it" to show
                                it's done.
                              </p>
                            </div>
                            <div className="card-icons"></div>
              ...
              <div className="menu-contents">
                ...
                <ul className="activity-list">
                  <li>
                    ...
                    <p>
                      <span className="member-name">Taylor Peat</span> changed
                  ...
                  <li>
                    ...
                    <p>
                      <span className="member-name">Taylor Peat</span> changed
                      the background of this board <small>5 hours ago</small>
                    </p>
                  </li>
                  <li>
                    <i className="member-icon"></i>
                    <p>
                      <span className="member-name">Taylor Peat</span> changed
                      the background of this board <small>6 hours ago</small>
                    </p>
                  </li>
                  <li>
                    <i className="member-icon"></i>
